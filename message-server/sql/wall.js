...
//删除反馈
exports.delFeedbacks = 'update feedbacks set isdeleted=1 where id=? and type=?'
//删除评论
...
//查找总反馈数
exports.findFeedbacksTotal = 'select count(*) as total from feedbacks where wallId=? and id=? and type=?  and isdeleted=0'
//查找评论数
exports.findCommentTotal = 'select count(*) as total from comments where id=? and wallId=? and isdeleted=0'
//是否点赞
exports.findIslike = 'select count(*) as total from feedbacks where wallId=? and id=? and userId=? and isdeleted=0'
//分页查找评论
exports.findComment = 'select * from comments where wallId=? and id=? and isdeleted=0 limit ?,?'

//通过id查找反馈
exports.findFeedbacksById = 'select * from feedbacks where id=? and type=?'
